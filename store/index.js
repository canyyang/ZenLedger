...
const store = createStore({
	state: {
		bookData: [],
		iconSrc: // [['/static/icons/food.svg', '/static/icons/subway.svg', '/static/icons/milk.svg', '/static/icons/fun.svg',
		[['/static/icons/food.svg', '/static/icons/subway.svg', '/static/icons/snack.svg', '/static/icons/milk.svg',
					'/static/icons/hospital.svg',  '/static/icons/room.svg', '/static/icons/love.svg', '/static/icons/other.svg'],
		...
		typeTitle: [['三餐', '交通', '零食', '奶茶', '医疗', '日用', '幸福', '其他'], 
